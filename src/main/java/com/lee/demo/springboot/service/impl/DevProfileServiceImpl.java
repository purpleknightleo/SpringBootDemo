...
/**
 * 开发环境服务实现类，通过@Profile("dev")表明开发环境处理逻辑
 * 
...
public class DevProfileServiceImpl implements ProfileService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DevProfileServiceImpl.class);

    @Override
    public void send() {
        logger.info("this is dev profile service");
    }
